<?php
     ...
     if($conn->connect_error){
         ...
         $stmt->bind_param("ssssssssssssssssssssssss",$studName,$gender,$birthday,$religion,$caste,$bg,$add1,$add2,$phn,$aphn,$email,$city,$state,$country,$idno,$uid,$photo,$class,$fName,$fNo,$fOcc,$mName,$mNo,$mOcc);
         $stmt-> execute();
         $stmt->close();
         $conn->close();
     }
